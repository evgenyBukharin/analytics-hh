...
;// CONCATENATED MODULE: ./src/js/components/hero-dynamic-content.js
...
`;
function updateContent(dashboardId, ageData, salaryData, avgAge, avgSalary, activeCandidates, activeCandidatesAl, commitedMeetings) {
...
function getAnalyticsData(dashboardId, requestPayload) {
  ...
  lib_axios.get("http://localhost:3000/analyticsData", {
    startDate: requestPayload.dates[0],
    endDate: requestPayload.dates[1],
    vacancies: vacanciesArr
  }).then(r => {
    updateContent(dashboardId, r.data.ageData, r.data.salaryData, r.data.avgAge, r.data.avgSalary, r.data.activeCandidates, r.data.activeCandidatesAll, r.data.commitedMeetings);
  }).catch(e => {
    console.log(e);
  });
}
